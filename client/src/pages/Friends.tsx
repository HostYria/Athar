  ...
  return (
    <div className="space-y-8 max-w-7xl">
      <div className="relative">
        ...
        <h1 className="text-5xl font-bold gradient-text mb-6 relative">Friends</h1>
      </div>

      <Card className="rounded-3xl border-white/20 dark:border-white/10 backdrop-blur-xl bg-white/70 dark:bg-white/5 shadow-xl">
        <CardHeader>
          <CardTitle className="text-xl gradient-text">Friends</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">Friends list will be available soon.</p>
        </CardContent>
      </Card>
    </div>
  );
